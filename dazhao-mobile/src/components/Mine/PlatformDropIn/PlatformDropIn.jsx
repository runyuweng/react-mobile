...
class PlatformDropIn extends React.Component {
    ...
    componentDidMount() {
        ...
        this.setState({platformDropIns:platformDropIns})
    ...
    changeShowAll(index){
        ...
        this.setState({
            platformDropIns:platformDropIns
        })
    }
    ...
    fetchPlatformDropIn(categoryId){
        ...
        then((data)=>{
            if(data.code==="S01"){
                ...
                this.setState({
                    platformDropIns:this.state.platformDropIns.push(platformDropIns)
                })
            }else if (data.code==="S02") {
                
            }else{
                this.setState({
                    platformDropIns:this.state.platformDropIns
                })
            }
        })
    }
